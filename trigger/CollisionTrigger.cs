...
public partial class CollisionTrigger : Area2D
{
    ...
    public void ExecArea2D(Area2D node) => Lib.ExecCommands(this, node, true);

    public void ExecExit(Node2D node) => Lib.ExecCommands(this, node, false);

    public void ExecExitArea2D(Area2D node) => Lib.ExecCommands(this, node, false);
}
