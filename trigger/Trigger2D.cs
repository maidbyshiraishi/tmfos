...
/// トリガー2D版
/// </summary>
public partial class Trigger2D : Node2D, IStateful
{
    /// <summary>
    /// 接触が継続して行われるか
    /// </summary>
    ...
    public override void _Ready()
    {
        ...
        CollidableArea collidableArea = GetNode<CollidableArea>("Area2D");
        collidableArea.Continuous = Continuous;
        collidableArea.WaitTime = WaitTime;
        collidableArea.Search = Search;
    }

    public void Exec(Node2D node, Area2D area)
    {
